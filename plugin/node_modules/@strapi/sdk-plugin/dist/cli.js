            ...
            switch (name) {
              ...
              case "typescript": {
                ...
                if (isRecord(pkgJson.exports["./strapi-admin"])) {
                  ...
                  if (isTypescript) {
                    const { adminTypescriptFiles } = await Promise.resolve().then(() => require("./_chunks/admin-BSmCHJGC.js"));
                    files.push(...adminTypescriptFiles);
                  } else {
                    const { adminJavascriptFiles } = await Promise.resolve().then(() => require("./_chunks/admin-BSmCHJGC.js"));
