...
import { b as Layouts, v as ContentBox } from './index-C02D7oHu.mjs';
...
const HomePage = () => {
  const Page2 = useEnterprise(
    ...
    async () => (await import('./HomePage-DebSqGMR.mjs')).HomePageEE
  );
  if (!Page2) {
    return null;
  }
...
//# sourceMappingURL=HomePage-gLvSEGxc.mjs.map
