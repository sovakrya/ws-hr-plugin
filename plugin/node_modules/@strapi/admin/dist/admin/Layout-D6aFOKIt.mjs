...
import { p as SETTINGS_LINKS_CE, b as Layouts } from './index-C02D7oHu.mjs';
...
const useSettingsMenu = () => {
  ...
  const { admin: adminLinks, global: globalLinks } = useEnterprise(
    ceLinks,
    async () => (await import('./index-C02D7oHu.mjs').then(n => n.J)).SETTINGS_LINKS_EE(),
    {
...
export { Layout };
//# sourceMappingURL=Layout-D6aFOKIt.mjs.map
