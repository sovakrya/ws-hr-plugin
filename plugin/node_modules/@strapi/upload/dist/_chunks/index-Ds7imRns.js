...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => Promise.resolve().then(() => require("./index-99duBF3G.js")),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      to: "media-library",
      Component: () => Promise.resolve().then(() => require("./index-QKcj2FTB.js")),
...
//# sourceMappingURL=index-Ds7imRns.js.map
